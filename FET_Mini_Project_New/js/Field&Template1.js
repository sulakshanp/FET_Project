...
// function printCV1() {
//     console.log("in print function t1")
//         // function download() {
//     totalDownloads1();
//     //weeklyDownloads();
//     const resumePdf = this.document.querySelector('#cv-template');
...
// var totalDownloads1 = () => {
//     console.log("sulakshan - totaldownloads printcv1 Field&T1");
//     let x;
//     $(document).ready(
//         () => {
...
// function countDownloads1(oldcount) {
//     let x = ++oldcount;
//     console.log(x)
//     var newCount = { id: 11, count: x };
...
function printCV1() {
    ...
    totalDownloads1();
    //weeklyDownloads();
    const resumePdf = this.document.querySelector('#cv-template1');
    console.log(resumePdf)
        // console.log(resumePdf);
        // console.log(window);
    var opt = {
